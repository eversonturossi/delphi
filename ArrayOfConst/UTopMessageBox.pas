...
type
  TTopMessageBox = class // create a dummy class
...
var
  EvHandler: TTopMessageBox;

implementation

{ TTopMessageBox }

procedure TTopMessageBox.btnClick(Sender: TObject);
begin
  fOpcao := TButton(Sender).Tag;
  Form.Close;
end;

function TTopMessageBox.Converte(Arg: TVarRec): String;
var
...
function TTopMessageBox.MensagemEscolha(AOwner: TComponent; Titulo, Mensagem: String; Args: array of const ): String;
var
  I: integer;
  TypeStr: String;
  btn: TButton;
