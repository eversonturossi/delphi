...
type
  ...
  private
    ...
    FInt64MethodCommand: TDBXCommand;
...
function TParametersServerModule1Client.Int64Method(InInt64: Int64; out OutInt64: Int64; var VarInt64: Int64): Int64;
begin
  if FInt64MethodCommand = nil then
  begin
    FInt64MethodCommand := FDBXConnection.CreateCommand;
    FInt64MethodCommand.CommandType := TDBXCommandTypes.DSServerMethod;
    FInt64MethodCommand.Text := 'TParametersServerModule1.Int64Method';
    FInt64MethodCommand.Prepare;
  end;
  FInt64MethodCommand.Parameters[0].Value.SetInt64(InInt64);
  FInt64MethodCommand.Parameters[2].Value.SetInt64(VarInt64);
  FInt64MethodCommand.ExecuteUpdate;
  OutInt64 := FInt64MethodCommand.Parameters[1].Value.GetInt64;
  VarInt64 := FInt64MethodCommand.Parameters[2].Value.GetInt64;
  Result := FInt64MethodCommand.Parameters[3].Value.GetInt64;
end;
...
begin
  ...
  FreeAndNil(FInt64MethodCommand);
