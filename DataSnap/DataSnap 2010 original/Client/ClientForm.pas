...
type
  ...
  private
    ...
    procedure TestComponentInt64;
    procedure TestClassInt64;
  public
    { Public declarations }
  end;
...
procedure TForm13.TestClassInt64;
var
  InInt64: Int64;
  VarInt64: Int64;
  OutInt64: Int64;
...
begin
  ...
  FDataSnapTestData.PopulateInt64(InInt64);
  FDataSnapTestData.PopulateInt64(VarInt64);

  ReturnInt64 := FParametersTest.Int64Method(InInt64, OutInt64, VarInt64);

  FDataSnapTestData.ValidateInt64(VarInt64);
  FDataSnapTestData.ValidateInt64(OutInt64);
  FDataSnapTestData.ValidateInt64(ReturnInt64);
end;

procedure TForm13.TestComponentInt64;
var
  InInt64: Int64;
  VarInt64: Int64;
begin
  SqlServerMethod1.CommandText := 'TParametersServerModule1.Int64Method';

  FDataSnapTestData.PopulateInt64(InInt64);
  FDataSnapTestData.PopulateInt64(VarInt64);

  SqlServerMethod1.Params[0].AsLargeInt := InInt64;
  SqlServerMethod1.Params[2].AsLargeInt := VarInt64;

  SqlServerMethod1.ExecuteMethod;

  FDataSnapTestData.ValidateInt64(SqlServerMethod1.Params[1].AsLargeInt);
  FDataSnapTestData.ValidateInt64(SqlServerMethod1.Params[3].AsLargeInt);
  FDataSnapTestData.ValidateInt64(SqlServerMethod1.Params[2].AsLargeInt);
...
begin
  try
    ...
    if not(DSProviderConnection1.Connected) then
